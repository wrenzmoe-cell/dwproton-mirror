...
- Updated Proton and components to `cachyos-11.0-20260428-proton-slr`
...
- Introduced `WINE_ENABLE_TIMEOUT_FIX=1` for people struggling to launch GI due to connection issues
